...
import background1 from '../../../images/inicio/background1.jpg';
import background2 from '../../../images/inicio/background2.jpg';
import background3 from '../../../images/inicio/background3.jpg';
...
function InicioLayout (){
    ...
    <div>
        ...
        <div className="parallax-container">
            ...
            <div >
                <img className="parallax" src={background1}  />
            </div>
        </div>
        ...
        <div >
            <img className="parallax" src={background2} />
        </div>
        </div>
        ...
        <div className="parallax-container valign-wrapper">
            ...
            <div><img className="parallax" src={background3}  /></div>
        </div>
